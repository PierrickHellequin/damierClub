  ...
  const handleSave = async () => {
    try {
      ...
      const payload: Partial<Member> = {
        ...
        active: values.active !== false, // Default to true
      };
      ...
      await memberProvider.createMember(payload);
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-900">Ajouter un nouveau membre</h2>
            <p className="text-gray-500 mt-1">Remplissez les informations du nouveau membre</p>
          </div>
        </div>
      </div>
